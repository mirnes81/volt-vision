...
export const mockInterventions: Intervention[] = [
  ...
  },
  {
    ...
    coordinates: { lat: 46.1884, lng: 6.1356 },
    type: 'cuisine',
    priority: 'normal',
    status: 'en_cours',
  ...
  },
  {
    id: 4,
    ref: 'INT-2024-004',
    label: 'Installation spots LED',
    clientId: 104,
    clientName: 'Cabinet Avocat Dumont',
    location: 'Boulevard des Philosophes 22, 1205 Genève',
    coordinates: { lat: 46.1958, lng: 6.1447 },
    type: 'installation',
    priority: 'normal',
    status: 'termine',
    description: 'Installation de 12 spots LED encastrables dans salle de réunion et accueil.',
    dateCreation: '2024-01-08',
    dateStart: '2024-01-15T10:00:00',
    dateEnd: '2024-01-15T16:00:00',
    tasks: [
      { id: 18, label: 'Perçage plafond', order: 1, status: 'fait', dateDone: '2024-01-15' },
      { id: 19, label: 'Installation spots', order: 2, status: 'fait', dateDone: '2024-01-15' },
      { id: 20, label: 'Test éclairage', order: 3, status: 'fait', dateDone: '2024-01-15' },
    ],
    materials: [
      { id: 5, productId: 10, productName: 'Spot LED encastrable', qtyUsed: 12, unit: 'pce' },
    ],
    hours: [
      { id: 4, userId: 1, userName: 'Jean Dupont', dateStart: '2024-01-15T10:00:00', dateEnd: '2024-01-15T16:00:00', durationHours: 6, workType: 'installation' },
    ],
    photos: [],
  },
  {
    id: 5,
    ref: 'INT-2024-005',
    label: 'Contrôle OIBT périodique',
    clientId: 105,
    clientName: 'Immeuble Résidence Parc',
    location: 'Chemin des Crêts 12, 1218 Grand-Saconnex',
    coordinates: { lat: 46.2344, lng: 6.1234 },
    type: 'oibt',
    priority: 'normal',
    status: 'a_planifier',
    description: 'Contrôle OIBT périodique pour l\'ensemble de l\'immeuble (20 appartements + parties communes).',
    dateCreation: '2024-01-20',
    dateStart: '2024-01-25T08:00:00',
    tasks: [
      { id: 21, label: 'Contrôle parties communes', order: 1, status: 'a_faire' },
      { id: 22, label: 'Contrôle appartements', order: 2, status: 'a_faire' },
      { id: 23, label: 'Rédaction rapport', order: 3, status: 'a_faire' },
    ],
    materials: [],
    hours: [],
    photos: [],
