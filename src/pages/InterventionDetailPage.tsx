...
import { MapPin, User, AlertTriangle, Clock, Package, CheckSquare, Camera, PenTool, Sparkles } from 'lucide-react';
    ...
    <div className="pb-4">
      ...
      <div className="px-4 space-y-4">
        ...
        <div className="animate-fade-in">
          {activeTab === 'hours' && (
            <HoursSection intervention={intervention} onUpdate={handleUpdate} />
          )}
          {activeTab === 'materials' && (
            <MaterialsSection intervention={intervention} onUpdate={handleUpdate} />
          )}
          {activeTab === 'tasks' && (
            <TasksSection intervention={intervention} onUpdate={handleUpdate} />
          )}
          {activeTab === 'photos' && (
            <PhotosSection intervention={intervention} onUpdate={handleUpdate} />
          )}
          {activeTab === 'ai' && (
            <AiSection intervention={intervention} onUpdate={handleUpdate} />
          )}
          {activeTab === 'signature' && (
            <SignatureSection intervention={intervention} onUpdate={handleUpdate} />
          )}
        </div>
      </div>
    </div>
